...
ModalRoot.displayName = 'Dialog.Root'
ModalTrigger.displayName = 'Dialog.Trigger'
ModalPortal.displayName = 'Dialog.Portal'
ModalOverlay.displayName = 'Dialog.Overlay'
ModalContent.displayName = 'Dialog.Content'
ModalTitle.displayName = 'Dialog.Title'
ModalDescription.displayName = 'Dialog.Description'
ModalActions.displayName = 'Modal.Actions'
ModalClose.displayName = 'Dialog.Close'